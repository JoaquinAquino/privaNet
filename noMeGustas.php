...
<?php
    ...
    ?>
<body onload="traerPublicacionesLog('0', '<?php echo $nombre; ?>', 'dislikes');">
    ...
    <div id="contenedorDerecho">
        <div id="contenedorIrVolver">
                    ...
                    echo 'onclick="volverLikesDislikesFav(\'' . $nombre . '\', \'dislikes\')"'; 
                    
                    ?>id="volverId" alt="volver" />	
                    <img src="./imagenes/irChiquito.svg" <?php 
                    echo 'onclick="avanzarLikesDislikesFav(\'' . $nombre . '\', \'dislikes\')"'; 
