...
<?php
    ...
    ?>
<body onload="traerPublicacionesLog('0', '<?php echo $nombre; ?>', 'favoritos');">
    ...
    <div id="contenedorDerecho">
        <div id="contenedorIrVolver">
                    ...
                    echo 'onclick="volverLikesDislikesFav(\'' . $nombre . '\', \'favoritos\')"'; 
                    
                    ?>id="volverId" alt="volver" />	
                    <img src="./imagenes/irChiquito.svg" <?php 
                    echo 'onclick="avanzarLikesDislikesFav(\'' . $nombre . '\', \'favoritos\')"'; 
